...
- (CGPoint)contentOffsetForIndex:(NSInteger)index
{
    ...
    CGFloat insetLeft = fabs(self.scrollView.contentInset.left);
//    CGFloat insetRight = fabs(self.scrollView.contentInset.right);
#warning position 要大于-insetLeft
    position = MAX(-insetLeft, position);
